...
exports.genIndicePage = function(data) {
    var pagHTML = `
    <!DOCTYPE html>
    <html>
        <head>
        ...
        <body>
            ...
            <div class="w3-container">
                <table class="w3-table-all w3-hoverable"> 
                    <tr> 
                        <td> <a href="pessoas"> Lista de pessoas </a> </td>
                    </tr>
                    <tr> 
                        <td> <a href="pessoas_ordenadas"> Lista de pessoas ordenada </a> </td>
                    </tr>
                    <tr> 
                        <td> <a href="sexo"> Distribuição por sexo </a> </td>
                    </tr>
                    <tr> 
                        <td> <a href="desporto"> Distribuição por desporto </a> </td>
                    </tr>
                    <tr> 
                        <td> <a href="profissoes"> Top10 de profissões </a> </td>
                    </tr>
                </table>
            </div>
...
exports.genListaPage = function(lista){
    ...
    <footer class="w3-container w3-deep-purple">
      <h5>TPC3 de EW por Dinis :  ${data}</h5>
    </footer>
...
<html>
    ...
    for(let i=0; i<lista.length;i++) {
        ...
        <tr>
            <td>${lista[i].id}</td>
            <td>
                <a href="http://localhost:5555/pessoas/${lista[i].id}">
                ${lista[i].nome}
                </a>
            </td>
            <td>${lista[i].idade}</td>
